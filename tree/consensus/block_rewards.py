...
def calculate_pool_reward(height: uint32) -> uint64:
    ...
    if height == 0:
        return uint64(int((7 / 8) * 21000000 * _mojo_per_tree))
        ...
        return uint64(int((7 / 8) * 0.125 * _mojo_per_tree))
...
def calculate_base_farmer_reward(height: uint32) -> uint64:
    ...
    """
    if height == 0:
        return uint64(int((1 / 8) * 21000000 * _mojo_per_tree))
    elif height < 3 * _blocks_per_year:
        ...
        return uint64(int((1 / 8) * 0.125 * _mojo_per_tree))
