...
default_kwargs = {
    ...
    "DIFFICULTY_STARTING": 1, # ~10-15TB, 10M iters, plot_eff_space * (dif/iters) * (dif_const_fac) / (bytes/TB)
    ...
    "NUMBER_ZERO_BITS_PLOT_FILTER": 0,  # No plot filter to force SSD use or suffer much lower effective capacity
    ...
    "GENESIS_CHALLENGE": bytes.fromhex("74726565313131a07e83deb5bef4d62f07094d52cb3178bc639a3ec0f2e98800"),
    # Forks of chia should change this value to provide replay attack protection. This is set to mainnet genesis chall
    "AGG_SIG_ME_ADDITIONAL_DATA": bytes.fromhex("74726565313131a07e83deb5bef4d62f07094d52cb3178bc639a3ec0f2e98800"),
    "GENESIS_PRE_FARM_POOL_PUZZLE_HASH": bytes.fromhex(
        "206d4bd708650bbcb468207dffca1b969a9ee733acc86200ada2f415119292f7"
    ),
