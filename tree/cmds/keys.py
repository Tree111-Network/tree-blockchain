...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Tree versions use "
...
@click.option("--prefix", "-x", help="Address prefix (tree111 for mainnet, ttree111 for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
