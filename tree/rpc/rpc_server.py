...
from tree.rpc.util import wrap_http_handler
from tree.server.outbound_message import NodeType
from tree.server.server import TreeServer, ssl_context_for_client, ssl_context_for_server
...
from tree.util.config import str2bool
from tree.util.ints import uint16
from tree.util.json_util import dict_to_json_str
from tree.util.network import WebServer
from tree.util.ws_message import WsRpcMessage, create_payload, create_payload_dict, format_response, pong
...
class RpcServiceProtocol(Protocol):
    ...
    def server(self) -> TreeServer:
        ...
        # a property so as to be read only which allows TreeServer to satisfy
        # Optional[TreeServer]
        ...
    ...
    def get_connections(self, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
        ...
        tree.rpc.rpc_server.default_get_connections()
        """
        ...
...
def default_get_connections(server: TreeServer, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
