...
from tree.data_layer.data_layer_wallet import Mirror, SingletonRecord
from tree.pools.pool_wallet_info import PoolWalletInfo
...
class WalletRpcClient(RpcClient):
    """
    Client to Tree RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    ...
    async def nft_mint_bulk(
        ...
        tree111_coins: Optional[List[Dict]] = None,
        tree111_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "tree111_change_target": tree111_change_target,
