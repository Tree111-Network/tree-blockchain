...
def calculate_pool_reward(height: uint32) -> uint64:
    ...
    if height == 0:
        return uint64(int((7 / 8) * _tree_prefarm * _mojo_per_chia))
    ...
    #     return uint64(int((7 / 8) * 0.25 * _mojo_per_chia))
        ...
        return uint64(int((7 / 8) * _tree_per_block * _mojo_per_chia))
...
def calculate_base_farmer_reward(height: uint32) -> uint64:
    ...
    """
    if height == 0:
        return uint64(int((1 / 8) * _tree_prefarm * _mojo_per_chia))
    # elif height < 3 * _blocks_per_year:
    ...
    #     return uint64(int((1 / 8) * 0.25 * _mojo_per_chia))
        ...
        return uint64(int((1 / 8) * _tree_per_block * _mojo_per_chia))
