...
required to run a [Timelord](https://github.com/Tree111-Network/tree-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Tree111-Network/tree-blockchain/blob/main/install-timelord.sh)
