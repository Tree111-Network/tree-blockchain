...
class _AssertRuntime:
    ...
    Produces output of the following form.
        ...
        /home/altendky/repos/tree-blockchain/tests/core/full_node/test_performance.py:187
...
@contextlib.contextmanager
def closing_tree_root_popen(tree_root: TreeRoot, args: List[str]) -> Iterator[subprocess.Popen[Any]]:
    environment = {**os.environ, "TREE_ROOT": os.fspath(tree_root.path)}
