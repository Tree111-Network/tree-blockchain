...
from tree.wallet.puzzles import p2_conditions, p2_delegated_puzzle_or_hidden_puzzle
...
from tree.clvm.spend_sim import SpendSim, SimClient

"""
This test suite aims to test:
    - tree.wallet.puzzles.singleton_top_layer.py
    - tree.wallet.puzzles.singleton_top_layer.clvm
    - tree.wallet.puzzles.singleton_top_layer_v1_1.py
    - tree.wallet.puzzles.singleton_top_layer_v1_1.clvm
    - tree.wallet.puzzles.p2_singleton.clvm
    - tree.wallet.puzzles.p2_singleton_or_delayed_puzhash.clvm
"""
...
class TestSingleton:
    ...
    async def test_singleton_top_layer(self, version):
        try:
            ...
            if version == 0:
                from tree.wallet.puzzles import singleton_top_layer

                adapted_puzzle: Program = singleton_top_layer.adapt_inner_to_singleton(starting_puzzle)  # noqa
            else:
                from tree.wallet.puzzles import singleton_top_layer_v1_1 as singleton_top_layer
