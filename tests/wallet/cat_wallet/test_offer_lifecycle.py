...
# This method takes a dictionary of strings mapping to amounts and generates the appropriate CAT/TREE111 coins
...
class TestOfferLifecycle:
    ...
    async def test_complex_offer(self, setup_sim):
        ...
        try:
            ...
            # Create an TREE111 Offer for RED
            ...
            # Create a RED Offer for TREE111
            ...
            # Create yet another offer of BLUE for TREE111 and RED
            ...
            assert new_offer.summary() == (
                ...
                {"tree111": 900, str_to_tail_hash("red").hex(): 350},
