...
from tree.protocols.wallet_protocol import CoinStateUpdate, RespondToCoinUpdates, RespondToPhUpdates
...
class TestSimpleSyncProtocol:
    ...
    async def test_subscribe_for_ph(self, wallet_node_simulator, self_hostname):
        ...
        from tree.wallet.puzzles.singleton_top_layer import SINGLETON_LAUNCHER_HASH
