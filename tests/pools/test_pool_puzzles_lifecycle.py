...
from tree.util.ints import uint64, uint32
...
from tree.wallet.puzzles.p2_conditions import puzzle_for_conditions
from tree.wallet.puzzles import singleton_top_layer
from tree.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - tree.pools.pool_puzzles.py
    - tree.wallet.puzzles.pool_member_innerpuz.clvm
    - tree.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
...
class TestPoolPuzzles(TestCase):
    def test_pool_lifecycle(self):
        ...
        GENESIS_CHALLENGE = bytes32.fromhex("74726565313131a07e83deb5bef4d62f07094d52cb3178bc639a3ec0f2e98800")
