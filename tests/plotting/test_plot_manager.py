...
from tree.plotting.cache import CURRENT_VERSION, CacheDataV1
from tree.plotting.manager import Cache, PlotManager
...
from tree.util.config import create_default_tree_config, lock_and_load_config, save_config
...
def environment(tmp_path, bt) -> Iterator[Environment]:
    ...
    create_default_tree_config(tmp_path)
