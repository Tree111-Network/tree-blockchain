...
from tree.protocols.shared_protocol import Handshake
...
class TestDos:
    ...
    async def test_spam_tx(self, setup_two_nodes_fixture, self_hostname):
        ...
        ws_con: WSTreeConnection = list(server_1.all_connections.values())[0]
        ws_con_2: WSTreeConnection = list(server_2.all_connections.values())[0]
