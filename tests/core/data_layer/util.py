...
from tree.data_layer.data_layer_util import NodeType, Side, Status
...
class TreeRoot:
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        kwargs["env"]["TREE_ROOT"] = os.fspath(self.path)
        kwargs["env"]["TREE_KEYS_ROOT"] = os.fspath(self.path)
        ...
        modified_args: List[Union[str, os_PathLike_str]] = [
            self.scripts_path.joinpath("tree"),
            "--root-path",
            self.path,
            *args,
        ]
