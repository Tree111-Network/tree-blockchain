...
rm -rf ../venv || true
rm -rf venv || true
rm -rf tree_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf tree-blockchain-gui/build || true
rm -rf tree-blockchain-gui/daemon || true
rm -rf tree-blockchain-gui/node_modules || true
rm tree-blockchain-gui/temp.json || true
( cd "$PWD/tree-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
